...
breadcrumbs:
  ...
  - 
    title: Código de Conduta
    permalink: /code-of-conduct/
page-header-lead: "Isso não é conversa fiada."
...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, via contato [{{site.email}}](mailto:{{site.email}}).
