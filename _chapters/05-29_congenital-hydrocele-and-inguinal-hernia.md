...
The undifferentiated gonad is attached to the posterior wall by the mesoperitoneum that, cranially, forms the diaphragmatic ligament and, caudally, the inguinal ligament (gubernaculum) ([Figure 3](#figure-3){:.figure-link})
...
**Second phase of descent:** the testicle passes through the already formed inguinal canal, reaching the scrotum between weeks 32 and 35 ([Figure 6](#figure-6){:.figure-link})

![Figure 6]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-6.png){:.float-start .img-fluid}  
**Figure 6**{:#figure-6}{:.figure-number} 28th week embryo

### Term Newborn

The testicle is fixed at the scrotum ([Figure 7](#figure-7){:.figure-link})
...
**Figure 7**{:#figure-7}{:.figure-number} Newborn
...
**Figure 8**{:#figure-8}{:.figure-number} Types of hydroceles
...
3. Incision over the muscular aponeurosis (not always needed) ([Figure 11](#figure-11){:.figure-link})
...
6. Cremasteric muscle is teased open by blunt dissection on the anteromedial surface of the cord and spread to expose the glistening peritoneum of the indirect hernia sac ([Figure 12](#figure-12){:.figure-link})
...
8. The cord´s contents are carefully set apart from the sac which is detached from the latter ([Figure 13](#figure-13){:.figure-link})
9. The hernial sac is opened and its content reduced to the abdominal cavity.
10. The hernial sac is twisted ensuring there is no content inside of it. An absorbable polyglactin knot is tied on its base and the sac is cut and lost into the abdominal cavity ([Figure 14](#figure-14){:.figure-link}), ([Figure 15](#figure-15){:.figure-link}), and ([Figure 16](#figure-16){:.figure-link})
11. Muscular Aponeurosis is closed with a continuous absorbable polyglactin suture if it is opened ([Figure 17](#figure-17){:.figure-link})
12. Separated knots are used to approximate subcutaneous tissue and an intradermal suture is used to approximate skin tissue ([Figure 18](#figure-18){:.figure-link})

![Figure 10]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-10.png){:.float-start .img-fluid}  
**Figure 10**{:#figure-10}{:.figure-number} Inguinal incision infants and adolescents

![Figure 11]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-11.png){:.float-start .img-fluid}  
**Figure 11**{:#figure-11}{:.figure-number} Incision over the muscular aponeurosis.

![Figure 12]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-12.png){:.float-start .img-fluid}  
**Figure 12**{:#figure-12}{:.figure-number} Inguinal cord identification. Hernial sac dissection.

![Figure 13]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-13.png){:.float-start .img-fluid}  
**Figure 13**{:#figure-13}{:.figure-number} Hernial sac dissection.

![Figure 14]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-14.png){:.float-start .img-fluid}  
**Figure 14**{:#figure-14}{:.figure-number} Hernial sac is twisted ensuring no content is present inside.

![Figure 15]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-15.png){:.float-start .img-fluid}  
**Figure 15**{:#figure-15}{:.figure-number} Hernial sac resected.

![Figure 16]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-16.png){:.float-start .img-fluid}  
**Figure 16**{:#figure-16}{:.figure-number} Sutured proximal end lost into the abdominal cavity.

![Figure 17]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-17.png){:.float-start .img-fluid}  
**Figure 17**{:#figure-17}{:.figure-number} Muscular aponeurosis closure.

![Figure 18]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-29-18.png){:.float-start .img-fluid}  
**Figure 18**{:#figure-18}{:.figure-number} Subcutaneous and skin closure.
