...
_<sup>1</sup> University of Tennessee Chattanooga, Chattanooga, TN, USA_{:.author-title}  
...
Approximately 10--20% of patients with VHL will develop PCC or PG.{% cite board2019a --file 08-42 %} Children with VHL may present with PCC as the event trigger a VHL diagnosis. These presentations may be atypical, including weight loss,{% cite igaki2018a --file 08-42 %} metastatic disease without symptoms after screening started,{% cite colvin2018a --file 08-42 %} and bilateral PCC.{% cite a2018a --file 08-42 %}
