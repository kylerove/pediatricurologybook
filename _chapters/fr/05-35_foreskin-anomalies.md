...
chapter: 35
sort-key: 05-35
title: Anomalies du prépuce
description: Le chapitre 35 donne un aperçu des anomalies du prépuce, notamment la balanite et le paraphimosis.
thumbnail: 05-35_foreskin-anomalies-fr.png
authors:
  -
    author-id: 75
  -
...
v1-permalinks:
  -
    title: Problèmes fréquents du prépuce et pénis enfoui
...
BXO (également appelé lichen scléreux) est une maladie inflammatoire chronique qui peut toucher le prépuce, le gland et l’urètre. Le nom dérive des trois composantes de la maladie, qui sont balanite (inflammation chronique du gland), xérotique (aspect anormalement sec de la lésion) et oblitérante (association à une endartérite occasionnelle).{% cite celis2014a --file 05-35 %}

L’incidence rapportée est de 0,4 cas/1000 garçons par an et la prévalence publiée du BXO chez les patients présentant un phimosis varie entre 9 et 50 %. L’âge moyen à la présentation a été rapporté comme étant de 8,9 à 10,6 ans, avec un pic d’incidence entre 9 et 11 ans.{% cite am2022a jayakumar2012a folaranmi2018a --file 05-35 %}

Dans une publication récente de Filho et al., la BXO a été diagnostiquée histologiquement chez 32 % des patients atteints de phimosis sans suspicion clinique de BXO après circoncision. Le degré de phimosis n'était pas corrélé à la présence de BXO.{% cite am2022a folaranmi2018a --file 05-35 %}

Le diagnostic est essentiellement clinique. Dans les formes légères de BXO, des zones de décoloration blanc grisâtre sur le gland ou la face interne du prépuce peuvent être observées ([Figure 2](#figure-2){:.figure-link}). À mesure que cette affection progresse, la peau devient inélastique, avec des plaques blanchâtres décolorées, ainsi qu’un phimosis fibreux progressif. Dans les cas plus sévères, on peut retrouver une ulcération et une atteinte du méat et de l’urètre.{% cite celis2014a folaranmi2018a --file 05-35 %}
...
Plusieurs techniques non invasives ont été décrites pour réduire un paraphimosis. Lorsque les mesures conservatrices échouent, des méthodes plus invasives peuvent être employées ([Figure 7](#figure-7){:.figure-link}).

![Figure 7]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-35-7.png){:.float-start .img-fluid}  
**Figure 7**{:#figure-7}{:.figure-number} Algorithme de prise en charge du paraphimosis.
...
- **Technique de ponction:** Une aiguille de calibre 26 G est utilisée pour réaliser environ 20 orifices de ponction dans le prépuce, réduisant l’œdème afin de permettre la réduction.{% cite little2005a anand2013a --file 05-35 %}
- **Aspiration pénienne:** un garrot est appliqué au niveau de la hampe du pénis, puis une aiguille de calibre 20 G est insérée parallèlement à l’urètre pour aspirer 3 à 12 ml de sang du gland. Cette procédure réduit le volume du gland afin de faciliter la réduction manuelle.{% cite anand2013a --file 05-35 %}
...
- **Préputioplastie:** l’anneau constricteur est identifié et une incision longitudinale dorsale de 1--2 cm est réalisée. La libération de l’anneau constricteur permet la diminution de l’œdème glandulaire, de sorte que le prépuce puisse être réduit. L’incision est ensuite suturée transversalement avec des points résorbables discontinus ([Figure 8](#figure-8){:.figure-link}).{% cite little2005a devries1996a --file 05-35 %}

![Figure 8]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-35-8.png){:.float-start .img-fluid}  
**Figure 8**{:#figure-8}{:.figure-number} Préputioplastie.

## Pénis peu apparent

Il s’agit d’une anomalie pénienne dans laquelle un pénis de longueur normale (de l’extrémité du gland au pubis) et de diamètre de hampe normal, paraît plus petit. Différentes entités sont incluses dans cette définition, telles que le pénis enfoui, le pénis piégé ou le pénis palmé.{% cite l-a shalaby2021a --file 05-35 %}
...
1.  Une forme congénitale avec un défaut de fixation entre la peau et la base du pénis, entraînant un aspect en tente. Son origine embryologique serait secondaire à un défaut de séparation des plans de migration au cours du développement des organes génitaux externes masculins. Cette anomalie entraîne des corps péniens bridés au fascia profond et un scrotum situé haut dans l’aine ([Figure 9](#figure-9){:.figure-link}).
2. Deux sous-catégories différentes peuvent être facilement identifiées selon la présence ou non d’un **mégaprépuce**, qui correspond à l’association d’un anneau phimotique avec un important ballonnement du feuillet interne du prépuce lors de la miction ([Figure 10](#figure-10){:.figure-link}). Ce phénomène peut provoquer un certain inconfort chez le patient. Cette tuméfaction hémisphérique est également appelée vessie préputiale et elle est habituellement constatée par les parents au cours des premiers mois de vie, qui doivent la comprimer manuellement pour permettre l’évacuation des urines par l’orifice phimotique.
3.  Une forme acquise due à l’obésité ([Figure 9](#figure-9){:.figure-link}). Celle-ci doit être distinguée de la forme transitoire de la petite enfance qui se résout avec l’âge et la déambulation
4.  Une forme cicatricielle secondaire à des chirurgies péniennes comme la circoncision.

![Figure 9]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-35-9.png){:.float-start .img-fluid}  
**Figure 9**{:#figure-9}{:.figure-number} Différentes formes de pénis enfoui : (a) Congénital avec mégaprépuce (b) Secondaire à l'obésité
...
**Figure 10**{:#figure-10}{:.figure-number} Mégaprépuce avec ballonnement du feuillet interne du prépuce pendant la miction.
...
Techniques chirurgicales utilisant la peau pénienne ([Figure 11](#figure-11){:.figure-link}):
...
- La première étape est la rétraction de la peau, qui peut être obtenue par une incision circonférentielle limitée au niveau de l'anneau étroit du prépuce externe ([Figure 11](#figure-11){:.figure-link} b).
...
- Le prépuce interne est entièrement réséqué, ne laissant qu'un manchon muqueux de 5 mm sous le gland ([Figure 11](#figure-11){:.figure-link} c-d).
...
Dans la publication de Ruiz et al., une approche simplifiée de cette malformation a été proposée. En utilisant le concept de Donahue du feuillet interne du prépuce, on réalise une fixation du feuillet externe du prépuce au fascia de Buck, et le feuillet interne du prépuce, déplié et ajusté, est utilisé pour recouvrir la hampe pénienne.{% cite ruiz2011a --file 05-35 %}

D'autre part, Rod _et al_ soulignent l'importance de réduire le prépuce interne en longueur et en circonférence afin d'éviter un aspect inesthétique. Ils ont également décrit l'importance de retirer le tissu sous-cutané du prépuce interne afin de réduire la probabilité de lymphœdème local.{% cite rod2013a --file 05-35 %}

La V‑plastie ventrale est une technique combinée où une incision en V est réalisée dans le feuillet préputial interne ventral. Ce feuillet préputial sera laissé en place afin d’être interposé et de faciliter la fermeture cutanée dans la partie ventrale de la hampe ([Figure 12](#figure-12){:.figure-link}).{% cite shalaby2021a --file 05-35 %}

![Figure 12]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-35-12.png){:.float-start .img-fluid}  
**Figure 12**{:#figure-12}{:.figure-number} Plastie en V ventrale chez un patient plus âgé présentant un déficit cutané ventral sévère.
...
La correction chirurgicale consiste en une incision cutanée transversale au niveau de la palmure, créant une séparation entre le pénis et le scrotum, laquelle est refermée verticalement.{% cite l-a shalaby2021a --file 05-35 %}
...
<p class="p-video-number">
  ...
  <strong id="video-1" class="video-number">[Vidéo 1](#video-1){:.video-link}.</strong> Réparation chirurgicale du pénis enfoui
</p>
...
*[EMLA]: crème topique lidocaïne/prilocaïne
