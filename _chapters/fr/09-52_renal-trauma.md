...
chapter: 52
sort-key: 09-52
title: Traumatisme rénal
description: Le chapitre 52 présente les types de traumatismes rénaux pédiatriques, les systèmes de classification en grades et les options de prise en charge.
thumbnail: 09-52_renal-trauma-fr.png
authors:
  -
    author-id: 102
  -
...
Le concept d’« hématurie significative » après un traumatisme est débattu chez l’enfant.{% cite unknown2018a --file 09-52 %} Alors que certains auteurs considèrent un seuil de \>5 hématies/HPF; d’autres préconisent **\>50 hématies/HPF**. L’hématurie seule, toutefois, n’est pas un marqueur fiable de l’atteinte rénale. De plus, le degré d’** hématurie ne corrèle pas avec le degré de lésion**.

Dans cette optique, d'autres recommandent **d'explorer toute hématurie** (microscopique ou macroscopique) **chez tout enfant** présentant un traumatisme abdominal fermé associé à un **mécanisme de décélération** (collision de véhicule à moteur (MVC), piéton percuté, chute de hauteur).{% cite unknown2018a --file 09-52 %}

## Examens diagnostiques

En cas de suspicion de lésion rénale, l'**échographie est l'outil initial de prise en charge**. Comme indiqué précédemment, de nombreuses lésions rénales surviennent dans le contexte d'un traumatisme abdominal fermé pour lequel les protocoles actuels prévoient une imagerie initiale de type **échographie FAST** ,{% cite ollerton2006a jm2018a --file 09-52 %} **Cette échographie fournira l'image initiale montrant que le rein est possiblement affecté par l'événement traumatique**.
...
- **La TDM avec contraste IV est la référence actuelle :** Elle permet d'évaluer l'anatomie et la fonction des reins et du système rénovasculaire de manière efficace et rapide. 
  ...
  - L'imagerie TDM standard obtient la phase artérielle et la phase corticale précoce... ce qui peut passer à côté de certaines lésions parenchymateuses ou du système collecteur.{% cite unknown2018a --file 09-52 %}
  - Les seuls résultats de la TDM ne DÉTERMINENT PAS la prise en charge.{% cite e2016a --file 09-52 %}
- **L'angiographie ou l'urographie IV peropératoire** sont également des outils d'imagerie dans certains cas.

### Classification

L’échelle des lésions d’organe de l’American Association for the Surgery of Trauma (AAST-OIS) est le système de classification le plus couramment utilisé pour les lésions des organes pleins, y compris le rein.{% cite ballon-landa2019a --file 09-52 %} Le système de classification est basé sur le scanner (TDM) et les constatations peropératoires. Ce système de classification est adapté de l’adulte et est toujours utilisé pour les traumatismes pédiatriques. Il est divisé en 5 grades : les grades 1-2 sont considérés comme de bas grade, tandis que les grades 4-5 sont de haut grade.
...
**Figure 1**{:#figure-1}{:.figure-number} Système de classification des traumatismes rénaux AAST-OIS.
...
Dans l'ensemble, les traumatismes rénaux chez les enfants sont **pris en charge de manière conservatrice**, même en cas de lésions de grade élevé.{% cite unknown2018a e2016a murphy2017a --file 09-52 %} Plus précisément, toutes les **lésions de grade I à III peuvent être prises en charge de manière non opératoire**.{% cite jm2012a --file 09-52 %} Des données indiquent que les grades IV et V peuvent également être pris en charge de manière conservatrice.{% cite e2016a --file 09-52 %} Ces lésions de grade plus élevé nécessitent une **approche prudente et adaptée** à chaque individu.{% cite unknown2018a --file 09-52 %} Cela est particulièrement pertinent chez les patients pédiatriques où **les lésions de grade IV sont une hétérogène** population.{% cite jm2018a --file 09-52 %}

![Figure 2]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-52-2.jpg){:.float-start .img-fluid}  
**Figure 2**{:#figure-2}{:.figure-number} Exemple de patient présentant un traumatisme rénal de grade IV lors de la présentation initiale, après 1 mois et après 8 mois.

Il faut toujours garder à l’esprit que le système de classification de l’American Association for the Surgery of Trauma n’est pas parfait et fait l’objet de controverses.{% cite murphy2017a --file 09-52 %} La raison en est que ce système de classification est fondé principalement sur la population adulte et peut ne pas refléter adéquatement la population pédiatrique.{% cite murphy2017a --file 09-52 %} Certains subdivisent davantage le grade IV pour cette raison.

**La chirurgie est recommandée** pour :{% cite unknown2018a --file 09-52 %}

- **Patients hémodynamiquement INSTABLES**
- Ceux présentant des lésions intra-abdominales **PÉNÉTRANTES** sévères.

**La chirurgie ou la radiologie interventionnelle peut être nécessaire** pour:{% cite unknown2018a --file 09-52 %}
...
*[MVC]: accident de véhicule motorisé
*[FAST]: évaluation ciblée par échographie en traumatologie 
*[US]: échographie
*[IVP]: urographie intraveineuse
*[CT]: tomodensitométrie
*[AAST]: Association américaine de chirurgie du traumatisme
*[OIS]: échelle des lésions d'organe
*[AV]: artérioveineux
