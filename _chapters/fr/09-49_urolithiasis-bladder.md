...
chapter: 49
sort-key: 09-49
title: Urolithiase—Vessie
description: Le chapitre 49 traite de la prise en charge chirurgicale de l'urolithiase vésicale.
thumbnail: 09-49_urolithiasis-bladder-fr.png
authors:
  -
    author-id: 97
  -
...
Les calculs vésicaux peuvent être idiopathiques/endémiques, secondaires et migrateurs. L'incidence des calculs vésicaux est plus faible dans le monde développé que dans le monde en développement et peut être attribuée à un régime pauvre en protéines animales. On observe une diminution globale de l'incidence des calculs endémiques, 'la vague lithiasique'. L'incidence des calculs vésicaux au Pakistan a diminué de 70 % en 1984 à 18 % en 2007 et de même dans la chaîne des Satpura en Inde centrale.{% cite soliman2017a --file 09-49 %} Malgré cela, la ceinture afro-asiatique des calculs vésicaux endémiques continue d'être une cause de morbidité due à la lithiase urinaire endémique. Une étude épidémiologique révèle que la maladie en Asie au 20<sup>e</sup> siècle est similaire à celle observée en Europe au XIXe siècle.{% cite asper1984a --file 09-49 %} Les calculs vésicaux endémiques sont fréquemment observés chez les enfants entre 1 et 5 ans, avec un pic à 3 ans, probablement en raison de la période de sevrage et d'un régime à base d'une seule céréale.{% cite soliman2017a --file 09-49 %} Ils sont plus fréquents chez les garçons avec M:F = 10:1, ce qui est vraisemblablement dû à des différences d'anatomie urétrale.{% cite philippou2012a --file 09-49 %}
...
L’augmentation vésicale séromusculaire est une alternative à l’iléocystoplastie et peut être associée à une moindre formation de calculs en raison de l’absence de mucus vésical. Bien qu’Odeh _et al_ n’aient pas constaté de formation de calculs après SMBA chez les 10 patients, par rapport aux 30 autres ayant subi une iléocystoplastie standard, la différence n’était pas significative.{% cite odeh2017a --file 09-49 %}
...
- Examen---vessie palpable, traits dysmorphiques du syndrome de Williams, rachitisme, tétanie et goutte, prolapsus rectal{% cite copelovitch2012a --file 09-49 %}
...
- Imagerie
    ...
    -   Radiographie abdominale sans préparation{% cite mandeville2011a --file 09-49 %}
...
La lithiase récidivante après cystoplastie d'augmentation demeure une préoccupation. Cohen _et al_ ont rapporté 63 % de récidive après un suivi de 5 ans.{% cite cohen1996a --file 09-49 %} Thomas _et al_ ont constaté 38 % de récidive dans leur revue.{% cite thomas2018a --file 09-49 %}
...
2. Spécifique
   -   Calculs calciques
       ...
       -   Hyperoxalurie
           ...
           -   Pyridoxine (vitamine B<sub>6</sub>)---diminue l'oxalate urinaire
           -   Oxalobacter formigenes---la colonisation intestinale par voie orale dégrade l'oxalate intestinal, entraînant une diminution des taux d'oxalate sanguin et urinaire--- thérapie novatrice{% cite alon2009a --file 09-49 %}
   -   Cystinurie
       ...
       -   D-pencillamine et tipronin---composés sulfhydryles, clivent la cystine en deux entités cystéine-disulfure qui sont 50 fois plus solubles que la cystine
           -   Si la D-penicillamine est utilisée au long cours, alors elle doit être supplémentée en pyridoxine (vitamine B<sub>6</sub>
    ...
    -   Calculs d'acide urique
        ...
        -   Si nécessaire, l'allopurinol peut être ajouté, car il réduit les taux d'acide urique.{% cite scoffone2018a --file 09-49 %}

#### Irrigation vésicale

Les protocoles d'irrigation vésicale au sérum physiologique et à la gentamicine, qui réduisent le mucus et la bactériurie, se sont révélés utiles pour diminuer l'incidence des calculs.{% cite hensle2004a --file 09-49 %} L'utilisation de l'hemiacidrin lors des irrigations vésicales était considérée comme ayant un rôle adjuvant pour diminuer les particules après l'ablation des calculs.{% cite blyth1992a --file 09-49 %}

- Un lavage quotidien de haut volume (250 mL) au sérum physiologique réduit la récidive de formation de calculs par rapport à un lavage de 120 mL / 60 mL. Réduit également la charge bactérienne et les infections urinaires récidivantes.{% cite husmann2016a --file 09-49 %} Avec une irrigation quotidienne de grand volume, l'incidence est \< 5 % sur un suivi de 10 ans.{% cite husmann2018a --file 09-49 %}
- Hensle _et al_ ont réduit l'incidence de survenue de calculs de 36 à 7 % grâce à un régime d'irrigation par lavage vésical. Ils utilisaient 120--240 mL de sérum physiologique avec un rinçage à la gentamicine une fois par semaine.{% cite hensle2004a --file 09-49 %}
- Kronner _et al_ ont également rapporté une incidence de formation de calculs de 7 % après l'utilisation d'un régime de lavage.{% cite kronner1998a --file 09-49 %}
- Chez les patients présentant des lithiases récidivantes---l'utilisation de mucolytiques a été testée, cependant aucun bénéfice n'a été démontré, bien que cela soit encore préconisé par certains en cas de production abondante de mucus.{% cite husmann2018a --file 09-49 %}
- Lavage avec une solution d'acétylcystéine (10 mL dans une solution d'acétylcystéine à 20 % avec 40 mL de sérum physiologique) 2--4 fois par jour en cas de mucus abondant.{% cite heijkant2011a --file 09-49 %} Ils ont réalisé un suivi à haute fréquence pour assurer l'observance. 28 enfants inclus avec formation de calculs chez 7 %.

#### Type d'augmentation

- L'augmentation vésicale séromusculaire n'a enregistré aucun calcul après un suivi moyen de 75 mois (intervalle 36--120 mois).{% cite odeh2017a --file 09-49 %}
- La formation de calculs est rarement observée avec les gastrocystoplasties, ce qui pourrait être attribué à une moindre production de mucus, un pH acide et une moindre bactériurie.{% cite kaefer1998a kronner1998a --file 09-49 %}
...
- Les nouvelles technologies utilisant des substituts autologues et d'ingénierie tissulaire en sont encore à la phase expérimentale de développement et pourraient montrer une certaine promesse contre le développement de calculs.{% cite unknown2017a --file 09-49 %}

### Alimentation

Les fruits et légumes contenant du magnésium, du potassium, des phytates et du citrate peuvent contribuer à réduire la charge calcique et donc la formation de calculs calciques, mais cet effet peut être atténué en raison de la teneur en oxalate de certains légumes. L’augmentation de la consommation de fruits et légumes chez les enfants présentant une hypocitraturie est protectrice.{% cite meschi2004a --file 09-49 %}

Les protéines animales, la viande rouge et la volaille, riches en acides aminés contenant du soufre (méthionine, cystine, homocystéine et taurine) peuvent induire une acidémie nette avec hypocitraturie, et celles riches en purines peuvent entraîner une hyperuricosurie. L’hypocitraturie comme l’hyperuricosurie peuvent entraîner une lithiase urinaire.{% cite curhan1993a --file 09-49 %}
...
L'accès percutané est également réalisable, et semble se comparer favorablement par rapport au groupe ouvert, sans les complications de la chirurgie ouverte.{% cite docimo1998a --file 09-49 %} La cystolitholapaxie percutanée est devenue le traitement de choix chez l'enfant, en raison des difficultés liées aux contraintes de calibre de l'urètre masculin.{% cite salah2005a --file 09-49 %}

Un fil guide est placé par voie percutanée sous contrôle cystoscopique, et le trajet est dilaté afin de permettre l'insertion d'une gaine d'accès telle que la gaine d'Amplatz (Cook Medical, États-Unis) de différentes tailles. Un néphroscope peut alors être utilisé pour l'extraction directe des calculs ou pour une litholapaxie.{% cite ahmadnia2013a --file 09-49 %} D'autres instruments pour l'accès percutané sont également possibles, tels qu'un port laparoscopique.{% cite chatterjee2021a --file 09-49 %} Afin d'éviter un traumatisme de la vessie lié au matériel de lithotritie, un sac de récupération laparoscopique peut être utilisé pour recueillir les calculs avant leur fragmentation et leur extraction.{% cite tan2014a --file 09-49 %}

La chirurgie laparoendoscopique transvésicale par orifice unique a été décrite pour les calculs vésicaux primaires, mais pas chez les patients porteurs d'une vessie augmentée.{% cite roslan2019a --file 09-49 %}

#### Accès au canal de Mitrofanoff / Monti

L'extraction complète des calculs est possible par le canal cathétérisable. Cela nécessite des dilatations sériées et l'utilisation d'une gaine d'Amplatz. Il a été démontré que cette méthode est sûre sans traumatisme significatif du canal cathétérisable.{% cite thomas2018a --file 09-49 %}

Plus récemment, des endoscopes de plus petit calibre, tels qu'un kit de mini PCNL 12 Fr, ont été décrits avec de bons résultats.{% cite sakly2021a --file 09-49 %}

Une chirurgie ouverte peut encore être nécessaire pour des calculs volumineux qui ne se prêtent pas à un abord mini-invasif.{% cite nang2018a --file 09-49 %} Cette éventualité est moins probable avec les protocoles de surveillance actuels et avec les stratégies de prévention décrites ci-dessous.

#### Chirurgie à ciel ouvert

Dans une revue systématique récente portant sur \> 1 000 cas, Davis _et al_ ont constaté que la chirurgie ouverte, la cystolitholapaxie transurétrale et percutanée présentaient des taux d'absence de calcul résiduel comparables, et que l'ESWL était moins efficace.{% cite davis2021a --file 09-49 %}

### Suivi suggéré

- Chez le patient ayant bénéficié d'une cystoplastie d'augmentation, une radiographie abdominale et une échographie annuelles sont suggérées pour la surveillance.{% cite szymanski2014a --file 09-49 %}
...
1. Des calculs urinaires surviennent dans la vessie augmentée chez jusqu’à 50 %, avec une incidence accrue si un conduit cathétérisable est utilisé dans les 3 ans suivant l’augmentation, ainsi que chez les patients sédentaires.
2. L’infection, les facteurs métaboliques, le type d’intervention et les agrafes jouent un rôle dans la formation des calculs. Les calculs sont majoritairement composés d’oxalate de calcium et de phosphate de calcium, ou de struvite s’ils sont liés à une infection.
3. La prise en charge diététique, le traitement médical et le lavage vésical peuvent réduire le risque de formation de calculs
4. Une surveillance continue est nécessaire.
5. Un traitement multimodal, avec recours à l’endoscopie, au laser et à la lithotripsie par ondes de choc, a un rôle dans la prise en charge individualisée de ces enfants.
{:.key-points-list}
...
*[CISC]: cathétérisme intermittent propre stérile
*[AC]: cystoplastie d'augmentation
*[SB]: spina bifida
*[SMBA]: augmentation vésicale séromusculaire
*[CT]: tomodensitométrie
*[US]: échographie
*[NSAIDs]: anti-inflammatoires non stéroïdiens
*[DASH]: approche diététique pour enrayer l'hypertension
*[YAG]: grenat d’yttrium-aluminium
*[ESWL]: lithotripsie extracorporelle par ondes de choc
