...
chapter: 25
sort-key: 04-25
title: Anomalías por duplicación uretral y siringocele
description: El capítulo 25 resume las anomalías de duplicación uretral y el siringocele.
thumbnail: 04-25_duplex-urethral-anomalies-and-syringocoele-es.png
authors:
  -
    author-id: 51
  -
...
v1-permalinks:
  -
    title: Duplicación uretral y otras anomalías uretrales (excepto hipospadias)
...
![Figura 1]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-25-1.jpg){:.float-start .img-fluid}  
**Figura 1**{:#figure-1}{:.figure-number} Exploración bajo anestesia que muestra una megalouretra de gran tamaño que compromete el cuerpo del pene.
...
![Figura 2]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-25-2.jpg){:.float-start .img-fluid}  
**Figura 2**{:#figure-2}{:.figure-number} Aspecto del siringocele no roto en MCUG

![Figura 3]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-25-3.jpg){:.float-start .img-fluid}  
**Figura 3**{:#figure-3}{:.figure-number} Aspecto de siringocele roto en la MCUG
...
![Figura 4]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-25-4.jpg){:.float-start .img-fluid}  
**Figura 4**{:#figure-4}{:.figure-number} Estudio cistográfico que muestra duplicación uretral en Y con flechas que señalan la uretra no dominante (dorsal).
...
*[UK]: Reino Unido
*[VUA]: válvulas uretrales anteriores
...
*[PADUA]: aumento progresivo mediante dilatación de la uretra anterior
*[PDS]: polidioxanona
*[MCU]: cistouretrografía miccional
