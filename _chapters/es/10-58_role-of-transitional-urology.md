...
chapter: 58
sort-key: 10-58
title: Papel de la urología de transición
description: El Capítulo 58 ofrece una visión de la subespecialidad más reciente dentro de la urología, la urología de transición, y cómo podemos abordar de forma sistemática la continuidad asistencial de los pacientes con anomalías urológicas congénitas.
thumbnail: 10-58_role-of-transitional-urology-es.png
authors:
  -
    author-id: 112
  -
...
El urólogo de transición se encarga de la atención de los pacientes de urología pediátrica a medida que pasan a la atención de adultos. Si bien los procesos patológicos que componen la urología de transición ([Tabla 1](#table-1){:.table-link}) son en sí mismos poco frecuentes, en conjunto representan una carga significativa. Se estima que en 2012 nacieron en Estados Unidos 3,573 bebés con espina bífida (2,765), válvulas uretrales posteriores (VUP, 493), extrofia vesical (118) o anomalías cloacales (197).{% cite martinez2016a --file 10-58 %} Al momento de redactar este texto, estos pacientes se acercan a la adolescencia y los recientes avances notables en el diagnóstico y la atención de las anomalías urogenitales congénitas y del disrafismo espinal permitirán que lo hagan con un éxito sin precedentes. En los próximos años, requerirán atención urológica de transición.
{:.drop-caps}

**Tabla 1**{:#table-1}{:.table-number} Afecciones que puede atender el urólogo de transición.

| Afecciones                                                        |
|-------------------------------------------------------------------|
| Intestino y vejiga neurogénicos                                   |
| &nbsp;&nbsp;&nbsp;&nbsp;_Espina bífida, parálisis cerebral, lesión medular, tumores del sistema nervioso central_ |
...
El embarazo se asocia con un mayor riesgo de infección del tracto urinario (ITU) en todas las pacientes. Esto es especialmente cierto en las pacientes con reconstrucción, que, además de un riesgo basal elevado de ITU, deben enfrentarse durante el embarazo a un aumento de las secreciones mucosas y a una posible dificultad para la cateterización. No es infrecuente que estas pacientes requieran drenaje urinario continuo en algún momento del embarazo debido a la imposibilidad de cateterizar.{% cite hensle2004a --file 10-58 %} Las pacientes con un tracto urinario reconstruido, particularmente aquellas en las que se utilizaron segmentos intestinales, presentan un mayor riesgo de pielonefritis durante el embarazo,{% cite huck2020a hautmann-a --file 10-58 %} lo que puede conducir a parto pretérmino, pérdida fetal o restricción del crecimiento fetal.
...
- {% reference r2021a --file 10-58 %} [enlace](https://university.auanet.org/core/pediatric/transitional-care/index.cfm)
- {% reference association2018a --file 10-58 %} [enlace](https://www.spinabifidaassociation.org/guidelines/)
...
*[ESPU]: Sociedad Europea de Urología Pediátrica
