...
chapter: 02
sort-key: 01-02
title: Imagenología del tracto urinario
description: El Capítulo 2 detalla las imágenes del tracto urinario pediátrico.
thumbnail: 01-02_imaging-of-the-urinary-tract-es.png
authors:
  -
    author-id: 12
layout: chapter
...
TFG (mL/min/1.73 m<sup>2</sup>) = 0.41 × talla / creatinina sérica

Existen fórmulas más recientes que proporcionan estimaciones más precisas de la función renal basadas en la creatinina sérica o la cistatina C, incluidas las ecuaciones CKiD-U25, que están ajustadas por edad, sexo y talla.{% cite pierce2021a --file 01-02 %} [Hay una calculadora disponible aquí.](https://qxmd.com/calculate/calculator_822/ckid-u25-egfr-calculator) Es importante señalar que los pacientes con enfermedad renal crónica dependientes de diálisis pueden recibir contraste yodado sin riesgo de LRA, ya que tienen riñones sin función.

### Agentes de contraste en RM

Para la RM con contraste se utiliza un quelato de gadolinio. Las reacciones alérgicas a estos agentes son aún menos probables que con el contraste yodado, con una tasa aproximada del 0,05%. El manejo de las reacciones alérgicas al gadolinio es el mismo que para los agentes de contraste yodados, y esto se tratará más adelante. Un riesgo exclusivo de los agentes de gadolinio es la fibrosis sistémica nefrogénica (FSN), una enfermedad que se asemeja a la esclerodermia y que puede conducir a contracturas articulares e insuficiencia orgánica y, en ocasiones, puede ser mortal.{% cite acr2022a --file 01-02 %} Esta entidad aún se comprende poco, pero, afortunadamente, es bastante rara. Los pacientes con lesión renal aguda, enfermedad renal crónica en estadio 4 o 5, o aquellos en diálisis pueden tener hasta un 7% de riesgo de desarrollar FSN con ciertos agentes de gadolinio (tipos I o posiblemente III). El uso de gadolinio en estos pacientes puede seguir siendo apropiado en casos poco frecuentes en los que el beneficio potencial de una RM con contraste sea muy alto. Sin embargo, en esta circunstancia es una buena práctica obtener un consentimiento informado. Siempre que sea posible, debería utilizarse en esta población un agente de gadolinio de menor riesgo (grupo II).{% cite acr2022a --file 01-02 %}

### Agentes de contraste ecográficos

Los agentes de contraste ecográfico consisten en una microesfera de fosfolípidos o proteínas que contiene un gas inerte ecogénico. Estos agentes mejoran transitoriamente la resolución de contraste ecográfica y están aprobados para uso intravenoso y endoluminal. Se requiere software ecográfico dedicado. Los agentes de contraste ecográfico son muy seguros, con reacciones graves que ocurren en aproximadamente el 0,01% de los casos. No se conoce toxicidad renal a las dosis aprobadas.{% cite acr2022a --file 01-02 %}
...
El régimen posológico actual se resume en la tabla a continuación ([Tabla 1](#table-1){:.table-link}).{% cite brown2020acr --file 01-02 %}

**Tabla 1**{:#table-1}{:.table-number} Dosis de epinefrina para reacciones al contraste.
...
Los criterios de adecuación del [Colegio Estadounidense de Radiología](https://www.acr.org/) (ACR) son recomendaciones de consenso, disponibles gratuitamente en línea para el clínico que busca el estudio de imagen más adecuado en diversas situaciones. Las recomendaciones son elaboradas por paneles de expertos y se actualizan con frecuencia.

**Tabla 2**{:#table-2}{:.table-number} Recomendaciones de ecografía renal según los Criterios de Adecuación del ACR.
...
Para las indicaciones a continuación, se recomienda la ecografía como modalidad de imagen inicial.{% cite brown2020acr karmazyn2018a --file 01-02 %}
...
![Figura 1]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-1.png){:.float-start .img-fluid}  
**Figura 1**{:#figure-1}{:.figure-number} Riñón normal en un lactante de cuatro meses de edad.

![Figura 2]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-2.png){:.float-start .img-fluid}  
**Figura 2**{:#figure-2}{:.figure-number} Riñón normal en un niño de 3 años.

![Figura 3]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-3.png){:.float-start .img-fluid}  
**Figura 3**{:#figure-3}{:.figure-number} Riñón normal en un paciente de 11 años.
...
![Figura 4]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-4.png){:.float-start .img-fluid}  
**Figura 4**{:#figure-4}{:.figure-number} Clasificación SFU de la dilatación del sistema colector

![Figura 5]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-5.png){:.float-start .img-fluid}  
**Figura 5**{:#figure-5}{:.figure-number} (a) La clasificación de la dilatación del tracto urinario (UTD) muestra una vista transversal del riñón en su porción media/interpolar. Las flechas verdes indican el diámetro anteroposterior (utilice la medición mayor). No se debe incluir la pelvis extrarrenal (flechas grises). (b) Vistas longitudinales de varios grados dentro del sistema de clasificación UTD. Adaptado de Chow et al 2017.{% cite chow2017classification --file 01-02 %}

![Figura 6]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-6.png){:.float-start .img-fluid}  
**Figura 6**{:#figure-6}{:.figure-number} Sistema colector duplicado en un recién nacido

![Figura 7]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-7.png){:.float-start .img-fluid}  
**Figura 7**{:#figure-7}{:.figure-number} Mismo paciente que en ([Figura 6](#figure-6){:.figure-link}) a las dos semanas de vida, mostrando una dilatación más grave

![Figura 8]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-8.png){:.float-start .img-fluid}  
**Figura 8**{:#figure-8}{:.figure-number} Obstrucción de la unión pieloureteral

![Figura 9]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-9.png){:.float-start .img-fluid}  
**Figura 9**{:#figure-9}{:.figure-number} Caliectasia severa y adelgazamiento cortical en un paciente con válvulas uretrales posteriores

#### Cribado para tumor en condiciones genéticas predisponentes como Beckwith-Wiedemann o WAGR

La ecografía puede detectar masas sólidas sutiles en niños pequeños, como se ilustra en el ejemplo a continuación. La frecuencia del cribado y el rango de edad varían según la condición predisponente específica.{% cite kalish2017a --file 01-02 %}

![Figura 10]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-10.png){:.float-start .img-fluid}  
**Figura 10**{:#figure-10}{:.figure-number} Masa renal hiperecogénica en la ecografía de cribado de un paciente con síndrome WAGR.

![Figura 11]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-11.png){:.float-start .img-fluid}  
**Figura 11**{:#figure-11}{:.figure-number} La RM confirmó múltiples masas (mismo paciente que la [Figura 10](#figure-10){:.figure-link}).

#### Flujo sanguíneo renal

La ecografía proporciona información valiosa en casos de sospecha de estenosis de la arteria renal.

![Figura 12]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-12.png){:.float-start .img-fluid}  
**Figura 12**{:#figure-12}{:.figure-number} Trazado arterial normal en un paciente de 11 años con hipertensión.
...
![Figura 13]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-13.png){:.float-start .img-fluid}  
**Figura 13**{:#figure-13}{:.figure-number} Cálculo en el polo inferior del riñón derecho.

![Figura 14]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-14.png){:.float-start .img-fluid}  
**Figura 14**{:#figure-14}{:.figure-number} El artefacto de centelleo mejora la conspicuidad de los cálculos.
...
![Figura 15]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-15.png){:.float-start .img-fluid}  
**Figura 15**{:#figure-15}{:.figure-number} Masa vesical altamente vascularizada en un adolescente.
...
La ecografía es la modalidad de elección para evaluar el escroto en el contexto de dolor o anomalía palpable.{% cite wang2019acr --file 01-02 %}
...
![Figura 16]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-16.png){:.float-start .img-fluid}  
**Figura 16**{:#figure-16}{:.figure-number} Hidroceles bilaterales en un neonato

![Figura 17]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-17.png){:.float-start .img-fluid}  
**Figura 17**{:#figure-17}{:.figure-number} Hidrocele no comunicante en un neonato

![Figura 18]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-18.png){:.float-start .img-fluid}  
**Figura 18**{:#figure-18}{:.figure-number} Hernia inguinal en un recién nacido

![Figura 19]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-19.png){:.float-start .img-fluid}  
**Figura 19**{:#figure-19}{:.figure-number} Testículo torsionado con ausencia de flujo en Doppler color

![Figura 20]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-20.png){:.float-start .img-fluid}  
**Figura 20**{:#figure-20}{:.figure-number} Testículo en torsión con ausencia de flujo sanguíneo en Doppler de potencia

![Figura 21]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-21.png){:.float-start .img-fluid}  
**Figura 21**{:#figure-21}{:.figure-number} Testículo derecho con torsión y flujo sanguíneo normal al testículo izquierdo

![Figura 22]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-22.png){:.float-start .img-fluid}  
**Figura 22**{:#figure-22}{:.figure-number} Rabdomiosarcoma paratesticular en un adolescente con masa palpable indolora

![Figura 23]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-23.png){:.float-start .img-fluid}  
**Figura 23**{:#figure-23}{:.figure-number} Imagen en color de rabdomiosarcoma paratesticular

![Figura 24]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-24.png){:.float-start .img-fluid}  
**Figura 24**{:#figure-24}{:.figure-number} Varicocele

![Figura 25]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-25.png){:.float-start .img-fluid}  
**Figura 25**{:#figure-25}{:.figure-number} Epididimitis
...
![Figura 27]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-27.png){:.float-start .img-fluid}  
**Figura 27**{:#figure-27}{:.figure-number} Clasificación radiológica del reflujo vesicoureteral

![Figura 28]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-28.png){:.float-start .img-fluid}  
**Figura 28**{:#figure-28}{:.figure-number} Ureterocele en retención de la última imagen fluoroscópica

![Figura 29]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-29.png){:.float-start .img-fluid}  
**Figura 29**{:#figure-29}{:.figure-number} Reflujo de grado 3 hacia ambos riñones

![Figura 30]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-30.png){:.float-start .img-fluid}  
**Figura 30**{:#figure-30}{:.figure-number} Reflujo de grado 5 en el lado derecho con inserción ectópica en la uretra

![Figura 31]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-31.png){:.float-start .img-fluid}  
**Figura 31**{:#figure-31}{:.figure-number} Uretra posterior dilatada y uréter derecho marcadamente dilatado en el contexto de válvulas uretrales posteriores

### Estudios con radionúclidos

#### DMSA / Gammagrafía renal estática

El ácido dimercaptosuccínico (DMSA) se une a las proteínas plasmáticas y es retenido por la corteza renal durante el aclaramiento renal, lo que permite la evaluación funcional. Los datos cuantitativos sobre la función renal son información crucial que no puede obtenerse mediante ecografía. La gammagrafía con Tc<sup>99m</sup> ácido dimercaptosuccínico (DMSA) se ha considerado la prueba de elección en la evaluación del daño parenquimatoso debido a pielonefritis aguda o crónica y proporciona datos sobre la función renal diferencial. No se requiere un catéter vesical para la exploración con DMSA, ya que el radiofármaco no se excreta en la orina. La SPECT con DMSA aumenta la sensibilidad, pero se requiere sedación en niños pequeños para obtener imágenes de alta calidad.{% cite sheehy2009a --file 01-02 %} El DMSA no proporciona información sobre el sistema colector ni sobre la urodinámica.
...
3. Técnica
   ...
   - Se generan curvas de aclaramiento y se calcula la t<sub>½</sub> (tiempo para que se elimine la mitad del radiotrazador)
4. Información obtenida
   - Perfusión renal
   - Perfusión cortical (función renal diferencial)
   - Tiempos de tránsito del parénquima y de todo el riñón
      - T<sub>½</sub> menor de 10 minutos es normal
      - T<sub>½</sub> entre 10 y 20 minutos indeterminado
      - T<sub>½</sub> mayor de 20 minutos sugiere obstrucción
5. Escollos
...
![Figura 33]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-33.png){:.float-start .img-fluid}  
**Figura 33**{:#figure-33}{:.figure-number} Gammagrafía con MAG 3 que muestra el flujo sanguíneo, la fase excretora y las curvas tiempo-actividad en un paciente con función renal simétrica y una obstrucción de la UPJ izquierda.
...
Una TC sin contraste puede ser ocasionalmente útil en el contexto pediátrico para el seguimiento de cálculos renales y ureterales, o para el diagnóstico cuando la ecografía no es concluyente.{% cite dillman2018acr --file 01-02 %} La ecografía puede no mostrar el cálculo obstructivo, especialmente si se encuentra en el uréter medio (donde las sombras del gas intestinal a menudo bloquean el haz ultrasónico). Sin embargo, la presencia de un sistema colector dilatado en el lado sintomático puede permitir al clínico inferir que hay un cálculo. En niños con cálculos conocidos o con afecciones que predisponen a cálculos, puede considerarse la TC. Pueden emplearse dosis de radiación muy bajas para evaluar la carga litiásica o para el seguimiento tras la intervención por cálculos.{% cite rodger2018a --file 01-02 %} Los protocolos para hematuria (TC trifásica con fases sin contraste, con contraste y tardía) no son apropiados en niños debido a la elevada carga de radiación.{% cite dillman2018acr --file 01-02 %}

En los Estados Unidos, la RM ha reemplazado en gran medida a la TC para la estadificación tumoral del abdomen y la pelvis pediátricos.{% cite voss2018a --file 01-02 %} Sin embargo, nuestros cirujanos pediátricos solicitan ocasionalmente una angiografía por TC (CTA) con fines de planificación. La CTA muestra las relaciones entre órganos y la anatomía vascular con menos artefactos y mayor resolución que la RM, lo que permite al cirujano planificar un abordaje más preciso en casos de tumor de Wilms, neuroblastoma u otras neoplasias malignas. Dado que la angiografía por TC requiere una inyección de contraste más rápida y conlleva una dosis de radiación más alta, estos estudios deben ser supervisados activamente por un radiólogo pediátrico.

![Figura 34]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-34.png){:.float-start .img-fluid}  
**Figura 34**{:#figure-34}{:.figure-number} TC con contraste que muestra laceración renal de alto grado del riñón izquierdo.

![Figura 35]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-35.png){:.float-start .img-fluid}  
**Figura 35**{:#figure-35}{:.figure-number} La imagen tardía a través del riñón descarta la disrupción del sistema colector.

![Figura 36]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-36.png){:.float-start .img-fluid}  
**Figura 36**{:#figure-36}{:.figure-number} Estudio por TC de litiasis en paciente con cistinuria; nótese la presencia de stents bilaterales parcialmente visibles.

![Figura 37]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-37.png){:.float-start .img-fluid}  
**Figura 37**{:#figure-37}{:.figure-number} Angiografía por TC con reconstrucción 3D en un paciente oncológico con anatomía arterial compleja; se identifican tres arterias renales para cada hemirriñón
...
En el diagnóstico fetal, la RM es una modalidad complementaria a la ecografía. Las secuencias de pulso rápidas son esenciales para la obtención de imágenes fetales. Si bien la RM fetal se solicita con mayor frecuencia para una evaluación adicional de una anomalía cerebral, también puede aportar información adicional sobre el tracto urinario fetal. Puede ser especialmente útil en el contexto de la planificación quirúrgica de anomalías urogenitales complejas.{% cite calvo-garcia2011a --file 01-02 %} En general, la calidad de imagen en la RM fetal mejora en etapas más avanzadas de la gestación.

1. Indicaciones de la RM en pediatría
   1. Estadificación de cánceres
   2. Sospecha de masa renal
   3. Cribado de pacientes en riesgo de tumor (p. ej., TS, VHL)
   4. Puede ser adecuada para pielonefritis complicada
2. Urografía por RM
   1. Método
      1. Urografía sensible al líquido utilizando técnicas de RM fuertemente ponderadas en T2
      2. Urografía excretora por RM utilizando secuencias ponderadas en T1 con contraste y furosemida
   2. Indicaciones
      1. Anatomía del sistema colector
      2. Determinar el nivel de obstrucción en las vías renales (intrínseca y extrínseca)
      3. Anomalías congénitas

![Figura 38]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-38.png){:.float-start .img-fluid}  
**Figura 38**{:#figure-38}{:.figure-number} Imagen de RM sensible al líquido con supresión de grasa que muestra dilatación del polo superior izquierdo en un riñón duplicado.

![Figura 39]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-39.png){:.float-start .img-fluid}  
**Figura 39**{:#figure-39}{:.figure-number} La imagen dinámica de RM poscontraste muestra un megauréter izquierdo dilatado pero no obstruido.

![Figura 40]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-40.png){:.float-start .img-fluid}  
**Figura 40**{:#figure-40}{:.figure-number} La imagen de RM sensible al líquido con supresión de grasa muestra un riñón en herradura hidronefrótico y una morfología de vejiga neurogénica.

![Figura 41]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-41.png){:.float-start .img-fluid}  
**Figura 41**{:#figure-41}{:.figure-number} La serie dinámica de RM poscontraste confirma la obstrucción del riñón en herradura.

![Figura 42]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-42.png){:.float-start .img-fluid}  
**Figura 42**{:#figure-42}{:.figure-number} Imagen de RM sensible al líquido con supresión de grasa muestra un pequeño riñón izquierdo displásico.

![Figura 43]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-43.png){:.float-start .img-fluid}  
**Figura 43**{:#figure-43}{:.figure-number} La serie dinámica de RM poscontraste muestra realce tardío y mínimo del riñón displásico, lo que indica función limitada.

![Figura 44]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-44.png){:.float-start .img-fluid}  
**Figura 44**{:#figure-44}{:.figure-number} La serie dinámica de RM tras la administración de contraste muestra un riñón derecho pequeño en un paciente con síndrome de Prune-Belly y reflujo vesicoureteral bilateral.

![Figura 45]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-45.png){:.float-start .img-fluid}  
**Figura 45**{:#figure-45}{:.figure-number} Imagen de RM sensible al líquido con supresión de grasa que muestra reemplazo del parénquima renal por múltiples masas en un paciente con nefroblastomatosis.

![Figura 46]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-46.png){:.float-start .img-fluid}  
**Figura 46**{:#figure-46}{:.figure-number} Las imágenes de RM poscontraste muestran las características de realce de las masas.

![Figura 47]({{ site.url }}{{ site.baseurl }}/assets/figures/figure-02-47.png){:.float-start .img-fluid}  
**Figura 47**{:#figure-47}{:.figure-number} Vista de un riñón y glándula suprarrenal normales en un feto con ascitis

### Intervención en urología pediátrica

Los procedimientos intervencionistas son fundamentales para el manejo de las afecciones urológicas pediátricas.{% cite hwang2018a sweed2016a --file 01-02 %} La subespecialidad de radiología pediátrica es distinta tanto de la radiología pediátrica como de la radiología intervencionista de adultos, y los profesionales de IR pediátrica siguen siendo pocos en número, a pesar del crecimiento de los últimos quince años.{% cite kaufman2017a --file 01-02 %}

#### Drenaje de las vías urinarias secundario a obstrucción/nefrostomías

1. Debe reservarse para pacientes en los que no sea posible el abordaje de drenaje retrógrado
2. La preparación preprocedimental incluiría la evaluación del riesgo de sangrado y de infección
3. Profilaxis antibiótica
4. Acceso al sistema colector renal ya sea mediante ecografía, fluoroscopia o tomografía computarizada
5. Complicaciones
   1. Hemorragia
   2. Sepsis
   3. Lesión de órgano
...
1. Reservado para pacientes que no son candidatos a la ureteroscopia o a la litotricia por ondas de choque
2. Procedimiento en dos pasos
   1. Acceso al sistema colector por el radiólogo utilizando ecografía/fluoroscopia
   2. Extracción del cálculo por el urólogo
...
*[APRPD]: diámetro anteroposterior de la pelvis renal
*[UTI]: dilatación del tracto urinario
*[WAGR]: Wilms, aniridia, genitourinario, retraso del desarrollo
*[PACS]: sistema de archivo y comunicación de imágenes
*[VUR]: reflujo vesicoureteral
*[ceVUS]: urosonografía miccional realzada con contraste
*[AP]: anteroposterior
...
*[TS]: esclerosis tuberosa
*[VHL]: Von Hippel Lindau
*[IR]: radiología intervencionista
